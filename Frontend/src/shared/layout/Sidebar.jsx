...
function Sidebar({ isMobileOpen = false, onClose = () => {} }) {
  ...
  return (
    <aside
      ...
      className={`fixed inset-y-0 left-0 z-40 h-dvh w-[250px] bg-[#213b97] px-5 pb-4 pt-8 text-[#c4cce7] transition-transform duration-300 ease-in-out lg:fixed lg:top-0 lg:z-30 lg:translate-x-0  ${
