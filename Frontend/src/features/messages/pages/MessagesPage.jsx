...
const MessagesPage = () => {
  ...
  //     ? "xl:grid-cols-[160px_minmax(0,1fr)] 2xl:grid-cols-[170px_minmax(0,1fr)]"
  //     : "xl:grid-cols-[160px_minmax(320px,420px)_minmax(0,1fr)] 2xl:grid-cols-[170px_minmax(340px,430px)_minmax(0,1fr)]";
  ...
  return (
    <MessagesShell>
      ...
      <div className="w-full max-w-full overflow-x-auto">
        <div
          // className={`grid gap-4 overflow-auto touch-auto xl:grid-cols-[160px_minmax(320px,420px)_minmax(0,1fr)] 2xl:grid-cols-[170px_minmax(340px,430px)_minmax(0,1fr)] ${layoutColumns}`}
